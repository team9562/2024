...
public class RotateSetpointAngle extends Command {
    ...
    public RotateSetpointAngle(AngleSubystem angle, ElevatorSubsystem elevator, IntakeSubsystem intake, double setpoint, boolean auto) {
        this.angle = angle;
    ...
    public void execute() {
        ...
        if (isSafe && intake.getState() != IntakeState.intake)
            angle.setTargetAngleDegrees(setpoint);
    }
