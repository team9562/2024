...
public class ThreeNoteAutoSequenceCommand extends SequentialCommandGroup {
    public ThreeNoteAutoSequenceCommand(AngleSubystem angle, ShooterSubsystem shooter, ElevatorSubsystem elevator,
