...
public class TwoNoteC4 extends SequentialCommandGroup {
    public TwoNoteC4(AngleSubystem angle, ShooterSubsystem shooter, ElevatorSubsystem elevator,
        ...
        addCommands(
                ...
                // C4
                new ParallelDeadlineGroup(
                        swerve.pathfind(isRed ? VantagePoints.PP_C4_VANTAGE_POINT_RED : VantagePoints.PP_C4_VANTAGE_POINT_BLUE, 1.25),
